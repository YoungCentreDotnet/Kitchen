...
namespace Kitchen.Backend.Controllers
{
    ...
    //public class KitchenControllers : ControllerBase
    //{
    //    private readonly IUserAccountService _account;

    //    public KitchenControllers(IUserAccountService account)
    //    {
    //        _account = account;
    ...
    //    }
    //    [HttpPost]
    //    public async Task<IActionResult> SignUpUserAsync([FromForm]Table entity)
    //    {
    ...
    //    }
    //    [HttpPatch]
    //    public async Task<IActionResult> UpdateUserAsync(int id , [FromForm] Table entity)
    //    {
